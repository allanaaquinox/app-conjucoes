...
public class Servidor {
    public static void main(String[] args) throws IOException {
        // Força o console a usar UTF-8 (evita que acentos apareçam errados ao printar ou ao rodar no terminal)
    ...
    private static void carregarConjuncoes() {
        ...
        adicionar("embora, conquanto, não obstante, ainda que, mesmo que, se bem que, posto que, por mais que, por pior que, apesar de que, a despeito de, malgrado, em que pese", "concessiva");
        adicionar("como, mais...do que, menos...do que, tão...como, tanto...quanto, tão...quanto, assim como", "comparativa");
        adicionar("se, caso, sem que, se não, a não ser que, exceto se, a menos que, contanto que, salvo se, desde que", "condicional");
